...
**Tests**: The examples below include test tasks. Tests are MANDATORY per BL4 Constitution TDD principle - all features must have comprehensive testing including unit, integration, and contract tests.
